...
3. **Approach exploration** (before planning):
   ...
   e. Before planning, confirm APPROACH.md records \`alignment_status: user_confirmed\` or \`alignment_status: approved_skip\` with source, date, scope, and rationale metadata. Agent-only "No questions needed" is not valid proof under \`workflow.discuss: true\`.
