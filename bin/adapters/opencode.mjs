...
3. **Approach exploration** (before planning):
   ...
   e. Before planning, confirm APPROACH.md records canonical proof fields: \`alignment_status: user_confirmed\` with \`alignment_method\`, \`user_confirmed_at\`, and \`confirmed_decisions\`; or \`alignment_status: approved_skip\` with \`explicit_skip_approved: true\`, \`alignment_method\`, \`user_confirmed_at\`, \`skip_scope\`, and \`skip_rationale\`. Agent-only "No questions needed" is not valid proof under \`workflow.discuss: true\`.
