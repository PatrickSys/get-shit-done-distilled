...
* upgrade CI to Node 22 (Node 20 actions deprecated June 2026) ([99ee48f](https://github.com/PatrickSys/get-shit-done-distilled/commit/99ee48f901c6c18cbaed7d2d8a9e8e7d17994c8a))
...
* trigger release after tag repair ([af8e40e](https://github.com/PatrickSys/get-shit-done-distilled/commit/af8e40e29f960c254a788bedcaaac890a43b2f3d))
...
* interactive init wizard + explicit governance consent (D36) ([#46](https://github.com/PatrickSys/get-shit-done-distilled/issues/46))
...
Current framework state: 39 design decisions documented in `distilled/DESIGN.md`.
...
Initial public release. 35 merged PRs, 862 structural assertions, 35 design decisions.
